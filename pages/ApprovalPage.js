                        ...
                        <div class="card-section map-card">
                            ...
                            <div class="today-approval-item cp-clickable" data-indicator="ap_case_count">
                                ...
                                <div class="today-approval-item cp-clickable" data-indicator="ap_item_count">
                                    ...
                                    <div class="today-approval-value-row">
                                        <span class="today-approval-value">999</span>
                        ...
                        <div class="card-section dataflow-card">
                            ...
                            <div id="dataflow-category" class="dataflow-content dataflow-content-hidden">
                                <div class="dataflow-stats">
                                    <div class="dataflow-stat-item" onclick="event.stopPropagation();window.approvalPage.openModal('push_data_analysis')" style="cursor: pointer;">
                                    ...
                                    <div class="dataflow-stat-item" onclick="event.stopPropagation();window.approvalPage.openModal('receive_data_analysis')" style="cursor: pointer;">
                                        <div class="dataflow-label-row">
        ...
        switch(type) {
            case 'ap_item_count': {
                ...
                overlay.innerHTML = this.renderApprovalPanorama({
                    title: '审批事项总量趋势分析',
                    kpis: [
                        { label: '审批事项总数', value: '999',  suffix: '项' },
                        { label: '去年同期',     value: '850',  suffix: '项' },
                        { label: '同比增加',     value: '149',   suffix: '项' },
                        { label: '同比上升',     value: '15', suffix: '%', highlight: 'up' }
                    ],
                    ...
                    rightPie: [
                        ...
                        { value: 25, name: '行政裁决', itemStyle: { color: '#526b9fff' } },
                        { value: 25, name: '行政奖励', itemStyle: { color: '#4e9c32ff' } },
                        { value: 25, name: '行政给付', itemStyle: { color: '#87428aff' } },
            ...
            case 'ap_case_count': {
                ...
                overlay.innerHTML = this.renderApprovalPanorama({
                    title: '审批办件总量趋势分析',
                    kpis: [
                        { label: '审批办件总数', value: '9856',  suffix: '件' },
