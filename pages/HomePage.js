window.HomePage = class HomePage {
                    ...
                    <div class="home-col-left">
                        <div class="card-section home-approval-section">
                            <div class="card-title-row">
                                ...
                                <div class="card-title-right" onclick="window.screenFrame.switchTab('approval')">办件总数 <span class="card-title-value">9,856项</span><span class="card-title-trend down">↓ 5.2%</span></div>
                            </div>
                        ...
                        <div class="card-section home-supervision-section">
                            <div class="card-title-row">
                                ...
                                <div class="card-title-right" onclick="window.screenFrame.switchTab('supervision')">对象总数 <span class="card-title-value">700.12万家</span> <span class="card-title-trend up">↑ 5.2%</span></div>
                            </div>
                            <div class="home-supervision-stat-row">
                                <div class="home-supervision-stat-card-horizontal" onclick="window.homePage.openModal('supervision_behavior_total')" style="cursor: pointer;">
                                    ...
                                    <span class="home-supervision-stat-value">2,456</span>
                                </div>
                                    ...
                                    <div class="home-new-supervision-scene">
                                        ...
                                        <div class="home-new-supervision-scene-cards">
                                            <div class="home-new-supervision-card-horizontal" onclick="window.homePage.openModal('sandbox_supervision')" style="cursor: pointer;">
                                                ...
                                                <div class="home-new-supervision-card-value">32</div>
                                            </div>
                                            <div class="home-new-supervision-card-horizontal" onclick="window.homePage.openModal('offsite_supervision')" style="cursor: pointer;">
                                                ...
                                                <div class="home-new-supervision-card-value">15</div>
                                            </div>
                                            <div class="home-new-supervision-card-horizontal" onclick="window.homePage.openModal('trigger_supervision')" style="cursor: pointer;">
                                                ...
                                                <div class="home-new-supervision-card-value">89</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-section today-approval-section">
                            <div class="today-approval-row">
                                ...
                                <div class="today-approval-item" onclick="window.homePage.openModal('admin_check_year_on_year')" style="cursor: pointer;">
                                    <span class="today-approval-label">行政检查总体减少</span>
                                    <div class="today-approval-value-row">
                                ...
                                <div class="today-approval-item" onclick="window.homePage.openModal('first_offense_exemption')" style="cursor: pointer;">
                                    <span class="today-approval-label">首违不罚、轻微免罚占比</span>
                                    <div class="today-approval-value-row">
                                        <span class="today-approval-value">50%</span>
    ...
    initCharts() {
        ...
        window.supervisionMethodPie.setOption({
            ...
            yAxis: { 
                type: 'value', 
                axisLabel: { formatter: '{value}次', fontSize: 12 },
                axisLine: { lineStyle: { color: 'rgba(255,255,255,0.2)' } },
                splitLine: { lineStyle: { color: 'rgba(255,255,255,0.1)' } }
            },
            series: [
                { name: '双随机一公开', type: 'line', smooth: false, symbol: 'circle', symbolSize: 6, data: [95, 72, 88, 65, 82, 98], lineStyle: { color: '#ff9500', width: 2 }, itemStyle: { color: '#ff9500' } },
                { name: '重点检查', type: 'line', smooth: false, symbol: 'circle', symbolSize: 6, data: [50, 85, 45, 78, 55, 48], lineStyle: { color: '#ffcc00', width: 2 }, itemStyle: { color: '#ffcc00' } },
                { name: '专项检查', type: 'line', smooth: false, symbol: 'circle', symbolSize: 6, data: [35, 55, 72, 42, 68, 38], lineStyle: { color: '#00d4ff', width: 2 }, itemStyle: { color: '#00d4ff' } },
                { name: '有因检查', type: 'line', smooth: false, symbol: 'circle', symbolSize: 6, data: [20, 35, 52, 25, 48, 18], lineStyle: { color: '#af52de', width: 2 }, itemStyle: { color: '#af52de' } },
                { name: '综合查一次', type: 'line', smooth: false, symbol: 'circle', symbolSize: 6, data: [10, 28, 45, 32, 55, 22], lineStyle: { color: '#00ff88', width: 2 }, itemStyle: { color: '#00ff88' } }
            ]
        });
