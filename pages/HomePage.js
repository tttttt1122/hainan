window.HomePage = class HomePage {
                ...
                <div class="home-layout-container">
                    <div class="home-col-left">
                            ...
                            <div class="home-approval-content">
                                <div class="home-approval-tabs-col">
                                    ...
                                    <div class="home-approval-tab" onclick="window.homePage.switchApprovalTab('reduction')">
                                        <span class="home-approval-tab-num">35%</span>
                                        压减比例
                                    </div>
                                </div>
                                <div class="home-approval-chart-col">
                                    <div id="approvalBar" class="chart-container"></div>
                                    <div id="approvalSpeedupBar" class="chart-container chart-hidden"></div>
                                </div>
                            </div>
                        </div>
                        <div class="card-section home-supervision-section">
                            <div class="card-title-row">
                                ...
                                <div class="card-title-right" onclick="window.screenFrame.switchTab('supervision')">对象总数 <span class="card-title-value">3,892家</span> <span class="card-title-trend up">↑ 5.2%</span></div>
                            </div>
                            <div class="home-supervision-stat-row">
                                <div class="home-supervision-stat-card-horizontal" onclick="window.homePage.openModal('supervision_behavior_total')" style="cursor: pointer;">
                                    <span class="home-supervision-stat-label">行为总数</span>
                                    <span class="home-supervision-stat-value">1,234</span>
                                </div>
                                <div class="home-supervision-stat-card-horizontal" onclick="window.homePage.openModal('supervision_problem_rate')" style="cursor: pointer;">
                                    <span class="home-supervision-stat-label">发现问题率</span>
                                    <span class="home-supervision-stat-value">15.6%</span>
                                </div>
                                <div class="home-supervision-stat-card-horizontal" onclick="window.homePage.openModal('supervision_visit_reduction')" style="cursor: pointer;">
                                    <span class="home-supervision-stat-label">减少上门次数</span>
                                    <span class="home-supervision-stat-value">892</span>
                                </div>
                                <div class="home-supervision-stat-card-horizontal" onclick="window.homePage.openModal('supervision_transfer_clues')" style="cursor: pointer;">
                                ...
                                <div class="home-supervision-chart-col">
                                    ...
                                    <div class="home-new-supervision-scene">
                                        ...
                                        <div class="home-new-supervision-scene-cards">
                                            <div class="home-new-supervision-card-horizontal" onclick="window.homePage.openModal('sandbox_supervision')" style="cursor: pointer;">
                                                <div class="home-new-supervision-card-title">沙盒监管</div>
                                                
                                            </div>
                                            <div class="home-new-supervision-card-horizontal" onclick="window.homePage.openModal('offsite_supervision')" style="cursor: pointer;">
                                                <div class="home-new-supervision-card-title">非现场监管</div>
                                                
                                            </div>
                                            <div class="home-new-supervision-card-horizontal" onclick="window.homePage.openModal('trigger_supervision')" style="cursor: pointer;">
                                                <div class="home-new-supervision-card-title">触发式监管</div>
                    ...
                    <div class="home-col-center">
                        ...
                        <div class="card-section home-realtime-section">
                            <div class="card-title-row">
                                <div class="card-title">审管法信流动数据</div>
                    ...
                    <div class="home-col-right">
                        <div class="card-section home-law-section">
                            <div class="card-title-row">
                                ...
                                <div class="card-title-right" onclick="window.screenFrame.switchTab('law')">案件总数 <span class="card-title-value">9件</span><span class="card-title-trend up">↑ 5.2%</span></div>
                            </div>
                            <div class="home-law-content">
                                <div class="home-law-stat-row-full">
                                    <div class="home-law-stat-card" onclick="window.homePage.openModal('law_case_source')" style="cursor: pointer;">
                                        ...
                                        <span class="home-law-stat-value">100件</span>
                                    </div>
                            ...
                            <div class="home-credit-content">
                                <div class="home-credit-stat-col">
                                    <div class="home-credit-stat-card-vertical" onclick="window.homePage.openModal('credit_b_above')" style="cursor: pointer;">
                                        ...
                                        <span class="home-credit-stat-value">89.8万户</span>
                                    ...
                                    <div class="home-credit-stat-card-vertical" onclick="window.homePage.openModal('credit_violation_rate')" style="cursor: pointer;">
                                        <span class="home-credit-stat-label">市场主体违法行为发生率</span>
                                        <span class="home-credit-stat-value">0.03%</span>
                                    </div>
                                </div>
                        ...
                        <div class="card-section home-flow-data-section">
                            <div class="card-title-row">
                                <div class="card-title">审管法信流动数据总数</div>
    ...
    switchApprovalTab(tab) {
        const tabs = document.querySelectorAll('.home-approval-tab');
        tabs.forEach(t => t.classList.remove('active'));
        
        const barChart = document.getElementById('approvalBar');
        const speedupChart = document.getElementById('approvalSpeedupBar');
        
        if (tab === 'case') {
            tabs[0].classList.add('active');
            barChart.classList.remove('chart-hidden');
            speedupChart.classList.add('chart-hidden');
            setTimeout(() => { try { window.approvalBar.resize(); } catch(e) {} }, 50);
        } else {
            tabs[1].classList.add('active');
            barChart.classList.add('chart-hidden');
            speedupChart.classList.remove('chart-hidden');
            setTimeout(() => { try { window.approvalSpeedupBar.resize(); } catch(e) {} }, 50);
        }
    }

    switchSupervisionTab(tab) {
        const tabs = document.querySelectorAll('.home-supervision-tab');
        tabs.forEach(t => t.classList.remove('active'));
        
        const methodPie = document.getElementById('supervisionMethodPie');
        const sceneCards = document.getElementById('supervisionSceneCards');
        
        [methodPie, sceneCards].forEach(el => el.classList.add('chart-hidden'));
        
        if (tab === 'method') {
            tabs[0].classList.add('active');
            methodPie.classList.remove('chart-hidden');
            setTimeout(() => { try { window.supervisionMethodPie.resize(); } catch(e) {} }, 50);
        } else {
            tabs[1].classList.add('active');
            sceneCards.classList.remove('chart-hidden');
        }
    }

    initCharts() {
        window.approvalBar = echarts.init(document.getElementById('approvalBar'));
        window.approvalBar.setOption({
            ...
            series: [{
                ...
                data: [
                    { value: 350, name: '高效办成一件事', itemStyle: { color: '#ff9500' } },
                    { value: 280, name: '极简审批', itemStyle: { color: '#ff6b30' } },
                    { value: 220, name: '智能快办', itemStyle: { color: '#ff8c00' } },
                    { value: 180, name: '免申即享', itemStyle: { color: '#ffaa00' } },
                    { value: 150, name: '全省通办', itemStyle: { color: '#ffbb50' } }
                ]
            }]
        });

        window.approvalSpeedupBar = echarts.init(document.getElementById('approvalSpeedupBar'));
        window.approvalSpeedupBar.setOption({
            tooltip: { trigger: 'axis', axisPointer: { type: 'shadow' } },
            grid: { left: '12%', right: '4%', bottom: '8%', top: '5%', containLabel: true },
            xAxis: { type: 'category', data: ['市场监管', '卫生健康', '自然资源', '交通运输', '文化旅游'], axisLabel: { color: 'rgba(255,255,255,0.7)', fontSize: 11 } },
            yAxis: { type: 'value', axisLabel: { color: 'rgba(255,255,255,0.7)', fontSize: 11, formatter: '{value}%' } },
            series: [{
                type: 'bar',
                data: [35, 30, 25, 20, 15],
                itemStyle: { 
        ...
        window.creditPie.setOption({
            ...
            series: [{
                ...
                data: [
                    { value: 35.9, name: 'A级', itemStyle: { color: '#ffcc00' } },
                    { value: 53.9, name: 'B级', itemStyle: { color: '#ff7f50' } },
                    { value: 8.0, name: 'C级', itemStyle: { color: '#ffcc00' } },
                    { value: 2.0, name: 'D级', itemStyle: { color: '#ff3b30' } }
                ]
            }]
        });
        ...
        window.supervisionTop10.setOption({
            tooltip: { trigger: 'axis', axisPointer: { type: 'shadow' } },
            grid: { left: '8%', right: '4%', bottom: '3%', top: '10%', containLabel: true },
            xAxis: { type: 'value', axisLabel: { color: 'rgba(255,255,255,0.7)', fontSize: 12, formatter: '{value}%' } },
            yAxis: { type: 'category', data: ['质量技术', '食品药品', '特种设备', '安全生产', '生态环境'], axisLabel: { color: 'rgba(255,255,255,0.7)', fontSize: 12 }, inverse: true },
            series: [{
                type: 'bar',
                data: [28, 24, 20, 16, 12],
                itemStyle: { 
        ...
        window.addEventListener('resize', () => {
            try { window.approvalBar.resize(); } catch(e) {}
            try { window.approvalSpeedupBar.resize(); } catch(e) {}
            try { window.lawTop10.resize(); } catch(e) {}
            try { window.creditPie.resize(); } catch(e) {}
            try { window.supervisionMethodPie.resize(); } catch(e) {}
            try { window.supervisionTop10.resize(); } catch(e) {}
        });
    }
            ...
            <div class="indicator-modal">
                ...
                <div class="indicator-modal-stats">
                    ...
                    <div class="indicator-stat-card">
                        ...
                        <span class="indicator-stat-value" style="color: #ffcc00;">2,277件</span>
                    </div>
                     <div class="indicator-stat-card">
    ...
    renderSupervisionBehaviorTotalModal() {
        return `
            <div class="indicator-modal">
                <div class="indicator-modal-header">
                    <span class="indicator-modal-title">检查行为总数构成分析</span>
                    <button class="indicator-modal-close">×</button>
                </div>
                <div class="indicator-modal-stats">
                    <div class="indicator-stat-card">
                    ...
                    <div class="indicator-stat-card">
                        ...
                        <span class="indicator-stat-value">250次</span>
                    </div>
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">有因检查</span>
                        <span class="indicator-stat-value">120次</span>
                    </div>
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">综合查一次</span>
                        <span class="indicator-stat-value">64次</span>
                    </div>
                </div>
                <div class="indicator-modal-chart" style="grid-template-columns: 5fr 5fr;">
                    <div class="indicator-chart-item">
                        <span class="indicator-chart-title">检查行为类型分布</span>
                        <div id="modal-behavior-pie" class="indicator-chart-container"></div>
                    </div>
                    <div class="indicator-chart-item">
                        <span class="indicator-chart-title">近6个月检查行为趋势</span>
    ...
    generateCheckBehaviorTableRows() {
        const types = ['双随机一公开', '重点检查', '专项检查', '有因检查', '综合查一次'];
    ...
    renderSupervisionProblemRateModal() {
        return `
            <div class="indicator-modal">
                <div class="indicator-modal-header">
                    <span class="indicator-modal-title">检查发现问题率深度分析</span>
                    <button class="indicator-modal-close">×</button>
                </div>
                <div class="indicator-modal-stats">
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">检查行为总数</span>
                        <span class="indicator-stat-value">1,234次</span>
                    </div>
                    <div class="indicator-stat-card">
                    ...
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">未发现问题数</span>
                        <span class="indicator-stat-value">1,042个</span>
                    </div>
                    <div class="indicator-stat-card">
                ...
                <div class="indicator-modal-chart" style="grid-template-columns: 5fr 5fr;">
                    ...
                    <div class="indicator-chart-item">
                        <span class="indicator-chart-title">各领域问题发现率排行</span>
    ...
    renderSupervisionVisitReductionModal() {
        return `
            <div class="indicator-modal">
                ...
                <div class="indicator-modal-stats">
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">改革前预计上门次数</span>
                        <span class="indicator-stat-value">1,560次</span>
                    </div>
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">实际上门次数</span>
                        <span class="indicator-stat-value">668次</span>
                    </div>
                    <div class="indicator-stat-card">
                    ...
                    <div class="indicator-stat-card">
                        ...
                        <span class="indicator-stat-value">57.2%</span>
                    </div>
                </div>
                <div class="indicator-modal-chart" style="grid-template-columns: 5fr 5fr;">
                    <div class="indicator-chart-item">
                        <span class="indicator-chart-title">改革前后对比</span>
                        <div id="modal-visit-bar" class="indicator-chart-container"></div>
                    </div>
                    <div class="indicator-chart-item">
                        <span class="indicator-chart-title">减少方式分布</span>
        ...
        return `
            <div class="indicator-modal">
                ...
                <div class="indicator-modal-stats">
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">市场主体总数</span>
                        <span class="indicator-stat-value">99.8万户</span>
                    </div>
                    <div class="indicator-stat-card">
                    ...
                    <div class="indicator-stat-card">
                        ...
                        <span class="indicator-stat-value">10万户</span>
                    </div>
                    <div class="indicator-stat-card">
            ...
            <div class="indicator-modal">
                ...
                <div class="indicator-modal-stats">
                    ...
                    <div class="indicator-stat-card">
                        ...
                        <span class="indicator-stat-value">300户</span>
                    </div>
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">无违法行为主体数</span>
                        <span class="indicator-stat-value">997,700户</span>
                    </div>
                    <div class="indicator-stat-card">
    ...
    renderAvgProcessTimeModal() {
        return `
            <div class="indicator-modal">
                ...
                <div class="indicator-modal-stats">
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">行政许可平均办件时长</span>
                        <span class="indicator-stat-value">1.2天</span>
                    </div>
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">行政确认平均办件时长</span>
                        <span class="indicator-stat-value">1.8天</span>
                    </div>
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">公共服务平均办件时长</span>
                        <span class="indicator-stat-value">0.8天</span>
                    </div>
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">行政裁决平均办件时长</span>
                        <span class="indicator-stat-value">2.2天</span>
                    </div>
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">行政奖励平均办件时长</span>
                        <span class="indicator-stat-value">3.0天</span>
                    </div>
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">行政给付平均办件时长</span>
                        <span class="indicator-stat-value">2.8天</span>
                    </div>
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">其他行政权力平均办件时长</span>
                        <span class="indicator-stat-value">2.5天</span>
                    </div>
                </div>
                <div class="indicator-modal-chart" style="grid-template-columns: 5fr 5fr;">
                    <div class="indicator-chart-item">
                        <span class="indicator-chart-title">各办件类型平均时长对比</span>
    ...
    generateAvgTimeTableRows() {
        const types = ['行政许可', '行政确认', '公共服务', '其他事项'];
        ...
        for (let i = 1; i <= 1000; i++) {
            ...
            let time = 0;
            if (type === '行政许可') time = (Math.random() * 1 + 0.5).toFixed(1);
            else if (type === '行政确认') time = (Math.random() * 1 + 1).toFixed(1);
            else if (type === '公共服务') time = (Math.random() * 0.5 + 0.3).toFixed(1);
            else time = (Math.random() * 2 + 1).toFixed(1);
            allItems.push({
                name: names[i % 6],
                type: type,
                time: time,
    ...
    generateProjectTableRows() {
        const types = ['工业项目', '商业项目', '服务业项目', '基础设施项目'];
            ...
            <div class="indicator-modal">
                ...
                <div class="indicator-modal-stats">
                    ...
                    <div class="indicator-stat-card">
                        ...
                        <span class="indicator-stat-value">10件</span>
                    </div>
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">未处置</span>
                        <span class="indicator-stat-value">2件</span>
                    </div>
                    
                    <div class="indicator-stat-card">
                        <span class="indicator-stat-label">处置率</span>
                        <span class="indicator-stat-value">83.3%</span>
                    </div>
                </div>
                <div class="indicator-modal-chart" style="grid-template-columns: 5fr 5fr;">
                    <div class="indicator-chart-item">
    ...
    generateTransferTableRows() {
        ...
        const items = allItems.slice(0, 5);
        const statusColors = { '已处置': '#ffcc00', '未处置': '#ff9500' };
        return items.map(item => `
            <tr>
                <td>${item.code}</td>
                <td>${item.name}</td>
    ...
    show() {
        ...
        setTimeout(() => {
            try {
                ...
                if (window.approvalSpeedupBar) window.approvalSpeedupBar.resize();
                ...
                if (window.supervisionTop10) window.supervisionTop10.resize();
            } catch(e) {}
        }, 100);
    }
    ...
    initSupervisionBehaviorTotalCharts() {
        ...
        pie.setOption({
            ...
            series: [{
                ...
                data: [
                    { value: 500, name: '双随机一公开', itemStyle: { color: '#ff9500' } },
                    { value: 300, name: '重点检查', itemStyle: { color: '#ffcc00' } },
                    { value: 250, name: '专项检查', itemStyle: { color: '#ff9500' } },
                    { value: 120, name: '有因检查', itemStyle: { color: '#af52de' } },
                    { value: 64, name: '综合查一次', itemStyle: { color: '#ffcc00' } }
                ]
            }]
        });
        ...
        bar.setOption({
            textStyle: { color: 'rgba(255,255,255,0.6)' },
            tooltip: { trigger: 'axis', axisPointer: { type: 'shadow' } },
            legend: { data: ['双随机一公开', '重点检查', '专项检查', '有因检查', '综合查一次'], textStyle: { color: 'rgba(255,255,255,0.6)' } },
            ...
            series: [
                { name: '双随机一公开', type: 'bar', data: [82, 90, 85, 92, 88, 63], itemStyle: { color: '#ff9500', borderRadius: [4, 4, 0, 0] } },
                { name: '重点检查', type: 'bar', data: [48, 52, 48, 48, 52, 52], itemStyle: { color: '#ffcc00', borderRadius: [4, 4, 0, 0] } },
                { name: '专项检查', type: 'bar', data: [42, 46, 42, 42, 46, 32], itemStyle: { color: '#ff9500', borderRadius: [4, 4, 0, 0] } },
                { name: '有因检查', type: 'bar', data: [20, 22, 20, 22, 22, 14], itemStyle: { color: '#af52de', borderRadius: [4, 4, 0, 0] } },
                { name: '综合查一次', type: 'bar', data: [10, 12, 10, 12, 12, 8], itemStyle: { color: '#ffcc00', borderRadius: [4, 4, 0, 0] } }
            ]
        });
    }
    ...
    initSupervisionProblemRateCharts() {
        ...
        const bar = echarts.init(document.getElementById('modal-problem-bar'));
        bar.setOption({
            textStyle: { color: 'rgba(255,255,255,0.6)' },
            tooltip: { trigger: 'axis', formatter: '{b}: {c}%' },
            grid: { left: '8%', right: '8%', bottom: '18%', top: '10%', containLabel: true },
            xAxis: { type: 'category', data: ['食品药品', '特种设备', '价格监管', '广告监管', '网络交易'], axisLabel: { fontSize: 11, interval: 0, rotate: 30 } },
            yAxis: { type: 'value', max: 50, axisLabel: { formatter: '{value}%' } },
            series: [{
                type: 'bar',
                data: [45, 42, 38, 35, 30],
    ...
    initSupervisionVisitReductionCharts() {
        ...
        bar.setOption({
            textStyle: { color: 'rgba(255,255,255,0.6)' },
            tooltip: { trigger: 'axis', axisPointer: { type: 'shadow' } },
            legend: { data: ['改革前', '改革后'], textStyle: { color: 'rgba(255,255,255,0.6)' } },
            grid: { left: '8%', right: '8%', bottom: '15%', top: '15%', containLabel: true },
            xAxis: { type: 'category', data: ['市场监管', '卫生健康', '自然资源', '生态环境', '交通运输'], axisLabel: { fontSize: 11, interval: 0, rotate: 30 } },
            yAxis: { type: 'value', axisLabel: { formatter: '{value}次' } },
            series: [
                { name: '改革前', type: 'bar', data: [380, 320, 280, 260, 320], itemStyle: { color: '#ff9500', borderRadius: [4, 4, 0, 0] } },
                { name: '改革后', type: 'bar', data: [150, 130, 120, 140, 128], itemStyle: { color: '#ffcc00', borderRadius: [4, 4, 0, 0] } }
            ]
        });
        ...
        pie.setOption({
            ...
            series: [{
                ...
                data: [
                    ...
                    { value: 372, name: '非现场监管', itemStyle: { color: '#ffcc00' } }
                ]
            }]
        });
    }
    ...
    initAvgProcessTimeCharts() {
        const bar = echarts.init(document.getElementById('modal-avg-time-bar'));
        bar.setOption({
            textStyle: { color: 'rgba(255,255,255,0.6)' },
            tooltip: { trigger: 'axis', formatter: '{b}: {c}天' },
            grid: { left: '8%', right: '8%', bottom: '20%', top: '10%', containLabel: true },
            xAxis: { type: 'category', data: ['行政许可', '行政确认', '公共服务', '行政裁决', '行政奖励', '行政给付', '其他行政权力'], axisLabel: { fontSize: 10, interval: 0, rotate: 30 } },
            yAxis: { type: 'value', max: 3.5, axisLabel: { formatter: '{value}天' } },
            series: [{
                type: 'bar',
                data: [1.2, 1.8, 0.8, 2.2, 3.0, 2.8, 2.5],
                itemStyle: { color: '#ff9500', borderRadius: [4, 4, 0, 0] },
                label: { show: true, position: 'top', formatter: '{c}天', color: 'rgba(255,255,255,0.6)', textBorderWidth: 0 }
            }]
        });
    ...
    initProjectApprovalLandingCharts() {
        ...
        bar.setOption({
            ...
            tooltip: { trigger: 'axis', formatter: '{b}: {c}天' },
            grid: { left: '8%', right: '8%', bottom: '18%', top: '10%', containLabel: true },
            xAxis: { type: 'category', data: ['工业项目', '商业项目', '服务业项目', '基础设施项目'], axisLabel: { fontSize: 11, interval: 0, rotate: 30 } },
            yAxis: { type: 'value', max: 12, axisLabel: { formatter: '{value}天' } },
            series: [{
                type: 'bar',
                data: [8.5, 9.9, 7.2, 11.5],
                itemStyle: { color: '#ffcc00', borderRadius: [4, 4, 0, 0] },
                label: { show: true, position: 'top', formatter: '{c}天', color: 'rgba(255,255,255,0.6)', textBorderWidth: 0 }
            }]
        });
    ...
    initAdminCheckYearOnYearCharts() {
        ...
        bar.setOption({
            ...
            series: [
                ...
                { name: '去年', type: 'bar', data: [105, 108, 112, 115, 120, 125, 100, 95, 105, 110, 120, 126], itemStyle: { color: 'rgba(255,255,255,0.3)', borderRadius: [4, 4, 0, 0] } }
            ]
        });
    ...
    initFirstOffenseExemptionCharts() {
        ...
        bar.setOption({
            ...
            series: [
                ...
                { name: '去年', type: 'bar', data: [6, 7, 7, 8, 8, 9, 7, 6, 7, 8, 9, 10], itemStyle: { color: 'rgba(255,255,255,0.3)', borderRadius: [4, 4, 0, 0] } }
            ]
        });
            ...
            series: [
                {
                    ...
                    lineStyle: { color: '#ff9500', width: 2 },
                    itemStyle: { color: '#ff9500' },
                    areaStyle: { color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{ offset: 0, color: 'rgba(255,149,0,0.3)' }, { offset: 1, color: 'rgba(255,149,0,0.05)' }]) },
                    label: { show: true, position: 'top', formatter: '{c}', color: '#ff9500', fontSize: 11 }
                }
            ]
        });
    }
