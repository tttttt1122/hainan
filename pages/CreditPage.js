window.CreditPage = class CreditPage {
    constructor(container) {
        ...
        // 信用全景分析弹窗
        this.caData = []; this.caPage = 1; this._caOvl = null; this._caCharts = {};
        this.csData = []; this.csPage = 1; this._csOvl = null; this._csCharts = {};
        this.clData = []; this.clPage = 1; this._clOvl = null; this._clCharts = {};
        this.crData = []; this.crPage = 1; this._crOvl = null; this._crCharts = {};
        this.render();
        this.initTabs();
        this.initCharts();
        this.bindEvents();
