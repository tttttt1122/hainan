window.LawPage = class LawPage {
                ...
                <div class="law-content">
                    ...
                    <div class="col-right">
                        <div class="card-section efficiency-section">
                            ...
                            <div class="stat-card-horizontal">
                                <div class="stat-item" data-case-efficiency="true">
                        ...
                        <div class="card-section review-section">
                            ...
                            <div class="review-content">
                                <div class="review-group" data-review-plan="true">
                                ...
                                <div class="review-group" data-review-task="true">
                                ...
                                <div class="review-group" data-review-dept="true">
                                ...
                                <div class="review-group" data-review-result="true">
    ...
    bindEvents() {
        this.container.addEventListener('click', (e) => {
            ...
            const rpTrigger = e.target.closest('[data-review-plan]');
            if (rpTrigger) {
                this.openReviewPlanModal();
                return;
            }
            const rtTrigger = e.target.closest('[data-review-task]');
            if (rtTrigger) {
                this.openReviewTaskModal();
                return;
            }
            const rdTrigger = e.target.closest('[data-review-dept]');
            if (rdTrigger) {
                this.openReviewDeptModal();
                return;
            }
            const rrTrigger = e.target.closest('[data-review-result]');
            if (rrTrigger) {
                this.openReviewResultModal();
                return;
            }
