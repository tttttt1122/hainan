window.LawPage = class LawPage {
                        ...
                        <div class="card-section map-card">
                            ...
                            <div class="today-approval-item cp-clickable" onclick="window.lawPage.openModal('lw_penalty_total')">
                                    ...
                                    <div class="today-approval-value-row">
                                        ...
                                        <span class="today-approval-change" style="color:#34c759;">↓7.4%</span>
                                    </div>
                                </div>
                                ...
                                <div class="today-approval-item cp-clickable" onclick="window.lawPage.openModal('lw_clue_accept')">
                                    ...
                                    <div class="today-approval-value-row">
                                        <span class="today-approval-value">218</span>
                                        <span class="today-approval-change" style="color:#ff3b30;">↑13.8%</span>
                                    </div>
                                </div>
                                ...
                                <div class="today-approval-item cp-clickable" onclick="window.lawPage.openModal('lw_major_case_ratio')">
                                    ...
                                    <div class="today-approval-value-row">
                                        <span class="today-approval-value">4%</span>
    ...
    openModal(type) {
        ...
        } else if (type === 'admin_lawsuit_rate') {
            overlay.innerHTML = this.renderAdminLawsuitRateModal();
        } else if (type === 'review_correction_rate') {
            overlay.innerHTML = this.renderReviewCorrectionRateModal();
        }
        ...
        if (type === 'admin_lawsuit_rate') {
            this.initAdminLawsuitRateCharts();
        } else if (type === 'review_correction_rate') {
            this.initReviewCorrectionRateCharts();
        } else {
        ...
        switch(type) {
            ...
            case 'lw_clue_accept': {
                ...
                overlay.innerHTML = this.renderLawTrend({
                    title: '线索受理总量趋势分析',
                    kpis: [
                        { label: '线索受理总数', value: '218',   suffix: '条' },
                        { label: '去年同期',     value: '187',   suffix: '条' },
                        { label: '同比增加',     value: '31',   suffix: '条' },
            ...
            case 'lw_major_case_ratio': {
                ...
                overlay.innerHTML = this.renderLawTrend({
                    title: '重大案件占比分析',
                    kpis: [
                        { label: '总案件数',     value: '100',   suffix: '件' },
                        { label: '重大案件数',   value: '4',     suffix: '件' },
                        { label: '一般案件数',   value: '96',   suffix: '件' },
                        { label: '重大案件占比', value: '4',   suffix: '%', highlight: 'up' }
                    ],
    ...
    renderAdminLawsuitRateModal() {
        const pages = Math.ceil(15 / 5);
        return `
            <div class="indicator-modal" style="width:85vw;">
                <div class="indicator-modal-header"><span class="indicator-modal-title">行政败诉率深度分析</span><button class="indicator-modal-close">×</button></div>
                <div class="indicator-modal-stats">
                    <div class="indicator-stat-card"><span class="indicator-stat-label">行政诉讼总数</span><span class="indicator-stat-value">1,245件</span></div>
                    <div class="indicator-stat-card"><span class="indicator-stat-label">行政败诉数</span><span class="indicator-stat-value" style="color:#ff3b30">15件</span></div>
                    <div class="indicator-stat-card"><span class="indicator-stat-label">非败诉数</span><span class="indicator-stat-value" style="color:#34c759">1,230件</span></div>
                    <div class="indicator-stat-card"><span class="indicator-stat-label">行政败诉率</span><span class="indicator-stat-value" style="color:#ff9500">1.2%</span></div>
                </div>
                <div class="indicator-modal-chart" style="display:flex;gap:10px;">
                    <div class="indicator-chart-item" style="flex:1;"><span class="indicator-chart-title">近12个月行政败诉率趋势</span><div id="lawsuit-line-chart" class="indicator-chart-container"></div></div>
                    <div class="indicator-chart-item" style="flex:1;"><span class="indicator-chart-title">败诉案件领域分布</span><div id="lawsuit-pie-chart" class="indicator-chart-container"></div></div>
                </div>
                <div class="indicator-modal-content">
                    <table class="indicator-modal-table">
                        <thead><tr><th>案件编号</th><th>案件名称</th><th>所属领域</th><th>原告/上诉人</th><th>审理法院</th><th>判决日期</th><th>败诉原因</th><th>整改状态</th></tr></thead>
                        <tbody>
                            <tr><td>XS-2025-001</td><td>XX公司不服行政处罚案</td><td>市场监管</td><td>海南XX科技有限公司</td><td>海口市中级人民法院</td><td>2025-03-15</td><td>程序违法</td><td><span class="status-badge status-completed">已整改</span></td></tr>
                            <tr><td>XS-2025-002</td><td>XX餐馆不服环保处罚案</td><td>生态环境</td><td>海口XX餐饮管理有限公司</td><td>海口市龙华区人民法院</td><td>2025-04-22</td><td>事实认定不清</td><td><span class="status-badge status-processing">整改中</span></td></tr>
                            <tr><td>XS-2025-003</td><td>XX物流不服超限处罚案</td><td>交通运输</td><td>海南XX物流有限公司</td><td>三亚市中级人民法院</td><td>2025-05-18</td><td>法律适用错误</td><td><span class="status-badge status-pending">未整改</span></td></tr>
                            <tr><td>XS-2025-004</td><td>XX商店不服占道经营处罚案</td><td>城管执法</td><td>三亚XX便利店</td><td>三亚市海棠区人民法院</td><td>2025-06-08</td><td>程序违法</td><td><span class="status-badge status-completed">已整改</span></td></tr>
                            <tr><td>XS-2025-005</td><td>XX企业不服土地处罚案</td><td>自然资源</td><td>海南XX实业有限公司</td><td>儋州市人民法院</td><td>2025-07-25</td><td>超越职权</td><td><span class="status-badge status-processing">整改中</span></td></tr>
                        </tbody>
                    </table>
                </div>
                <div class="indicator-modal-pagination">
                    <button class="indicator-pagination-btn" disabled>上一页</button>
                    <span class="indicator-pagination-info">第 1 / ${pages} 页</span>
    ...
    renderReviewCorrectionRateModal() {
        const pages = Math.ceil(15 / 5);
        return `
            <div class="indicator-modal" style="width:85vw;">
                <div class="indicator-modal-header"><span class="indicator-modal-title">复议被纠错率深度分析</span><button class="indicator-modal-close">×</button></div>
                <div class="indicator-modal-stats">
                    <div class="indicator-stat-card"><span class="indicator-stat-label">行政复议总数</span><span class="indicator-stat-value">890件</span></div>
                    <div class="indicator-stat-card"><span class="indicator-stat-label">复议被纠错数</span><span class="indicator-stat-value" style="color:#ff3b30">22件</span></div>
                    <div class="indicator-stat-card"><span class="indicator-stat-label">复议维持数</span><span class="indicator-stat-value" style="color:#34c759">868件</span></div>
                    <div class="indicator-stat-card"><span class="indicator-stat-label">复议被纠错率</span><span class="indicator-stat-value" style="color:#ff9500">2.5%</span></div>
                </div>
                <div class="indicator-modal-chart" style="display:flex;gap:10px;">
                    <div class="indicator-chart-item" style="flex:1;"><span class="indicator-chart-title">近12个月复议被纠错率趋势</span><div id="review-line-chart" class="indicator-chart-container"></div></div>
                    <div class="indicator-chart-item" style="flex:1;"><span class="indicator-chart-title">纠错类型分布</span><div id="review-pie-chart" class="indicator-chart-container"></div></div>
                </div>
                <div class="indicator-modal-content">
                    <table class="indicator-modal-table">
                        <thead><tr><th>复议案件编号</th><th>原行政行为名称</th><th>申请人与被申请人</th><th>所属领域</th><th>复议决定日期</th><th>纠错类型</th><th>纠错原因</th><th>整改状态</th></tr></thead>
                        <tbody>
                            <tr><td>FY-2025-001</td><td>工商行政处罚决定</td><td>申请人：XX公司；被申请人：海口市市场监管局</td><td>市场监管</td><td>2025-03-20</td><td>撤销</td><td>事实不清</td><td><span class="status-badge status-completed">已整改</span></td></tr>
                            <tr><td>FY-2025-002</td><td>环保行政处罚决定</td><td>申请人：XX工厂；被申请人：三亚市生态环境局</td><td>生态环境</td><td>2025-04-15</td><td>变更</td><td>程序违法</td><td><span class="status-badge status-processing">整改中</span></td></tr>
                            <tr><td>FY-2025-003</td><td>交通违法罚款决定</td><td>申请人：XX运输公司；被申请人：省交通厅</td><td>交通运输</td><td>2025-05-10</td><td>确认违法</td><td>适用法律错误</td><td><span class="status-badge status-pending">未整改</span></td></tr>
                            <tr><td>FY-2025-004</td><td>城管行政处罚决定</td><td>申请人：XX商户；被申请人：海口市综合执法局</td><td>城管执法</td><td>2025-06-05</td><td>责令履行</td><td>滥用职权</td><td><span class="status-badge status-completed">已整改</span></td></tr>
                            <tr><td>FY-2025-005</td><td>土地行政处罚决定</td><td>申请人：XX开发公司；被申请人：省自然资源厅</td><td>自然资源</td><td>2025-07-22</td><td>撤销</td><td>事实不清</td><td><span class="status-badge status-processing">整改中</span></td></tr>
                        </tbody>
                    </table>
                </div>
                <div class="indicator-modal-pagination">
    ...
    initAdminLawsuitRateCharts() {
        if (typeof echarts === 'undefined') return;
        setTimeout(() => {
            const lineChart = echarts.init(document.getElementById('lawsuit-line-chart'));
            lineChart.setOption({
                tooltip: { trigger: 'axis', formatter: '{b}: {c}%' },
                grid: { left: '8%', right: '5%', bottom: '10%', top: '10%', containLabel: true },
                xAxis: { type: 'category', data: ['7月','8月','9月','10月','11月','12月','1月','2月','3月','4月','5月','6月'], axisLabel: { color: 'rgba(255,255,255,0.6)', fontSize: 11 }, axisLine: { lineStyle: { color: 'rgba(0,212,255,0.2)' } } },
                yAxis: { type: 'value', axisLabel: { color: 'rgba(255,255,255,0.6)', fontSize: 11, formatter: '{value}%' }, splitLine: { lineStyle: { color: 'rgba(0,212,255,0.08)' } } },
                series: [{
                    type: 'line', data: [1.5, 1.3, 1.8, 1.2, 1.0, 1.1, 1.3, 1.4, 1.2, 1.0, 1.1, 1.2],
            ...
            const pieChart = echarts.init(document.getElementById('lawsuit-pie-chart'));
            pieChart.setOption({
                tooltip: { trigger: 'item', formatter: '{b}: {c}件 ({d}%)' },
                legend: { orient: 'vertical', right: '2%', top: 'middle', textStyle: { color: 'rgba(255,255,255,0.7)', fontSize: 11 } },
                series: [{
                    type: 'pie', radius: ['45%', '70%'], center: ['40%', '50%'],
                    itemStyle: { borderRadius: 4, borderColor: 'rgba(5,13,24,0.9)', borderWidth: 2 },
                    label: { show: false },
                    data: [
                        { value: 4, name: '市场监管', itemStyle: { color: '#00d4ff' } },
                        { value: 3, name: '生态环境', itemStyle: { color: '#34c759' } },
                        { value: 3, name: '交通运输', itemStyle: { color: '#ff9500' } },
                        { value: 2, name: '城管执法', itemStyle: { color: '#ff3b30' } },
                        { value: 2, name: '自然资源', itemStyle: { color: '#af52de' } },
                        { value: 1, name: '其他', itemStyle: { color: '#8e8e93' } }
                    ]
                }]
            });
    ...
    initReviewCorrectionRateCharts() {
        if (typeof echarts === 'undefined') return;
        setTimeout(() => {
            const lineChart = echarts.init(document.getElementById('review-line-chart'));
            lineChart.setOption({
                tooltip: { trigger: 'axis', formatter: '{b}: {c}%' },
                grid: { left: '8%', right: '5%', bottom: '10%', top: '10%', containLabel: true },
                xAxis: { type: 'category', data: ['7月','8月','9月','10月','11月','12月','1月','2月','3月','4月','5月','6月'], axisLabel: { color: 'rgba(255,255,255,0.6)', fontSize: 11 }, axisLine: { lineStyle: { color: 'rgba(0,212,255,0.2)' } } },
                yAxis: { type: 'value', axisLabel: { color: 'rgba(255,255,255,0.6)', fontSize: 11, formatter: '{value}%' }, splitLine: { lineStyle: { color: 'rgba(0,212,255,0.08)' } } },
                series: [{
                    type: 'line', data: [2.8, 2.5, 3.0, 2.3, 2.0, 2.2, 2.5, 2.6, 2.4, 2.2, 2.4, 2.5],
                    smooth: true, symbol: 'circle', symbolSize: 6,
                    lineStyle: { color: '#ff9500', width: 2 },
                    itemStyle: { color: '#ff9500' },
                    areaStyle: { color: new echarts.graphic.LinearGradient(0,0,0,1,[{offset:0,color:'rgba(255,149,0,0.3)'},{offset:1,color:'rgba(255,149,0,0.02)'}]) }
                }]
            });

            const pieChart = echarts.init(document.getElementById('review-pie-chart'));
            pieChart.setOption({
                tooltip: { trigger: 'item', formatter: '{b}: {c}件 ({d}%)' },
                legend: { orient: 'vertical', right: '2%', top: 'middle', textStyle: { color: 'rgba(255,255,255,0.7)', fontSize: 11 } },
                series: [{
                    ...
                    label: { show: false },
                    data: [
                        { value: 8, name: '撤销', itemStyle: { color: '#ff3b30' } },
                        { value: 5, name: '变更', itemStyle: { color: '#ff9500' } },
                        { value: 4, name: '确认违法', itemStyle: { color: '#af52de' } },
                        { value: 3, name: '责令履行', itemStyle: { color: '#00d4ff' } },
