                        ...
                        <div class="card-section">
                            <div class="top10-container">
                                <div class="top10-section">
                                    ...
                                    <tbody>
                                        <tr><td>食品安全日常检查</td><td>9843</td></tr><tr><td>特种设备安全监察</td><td>8721</td></tr><tr><td>药品经营质量管理检查</td><td>7654</td></tr><tr><td>市场主体登记事项核查</td><td>6587</td></tr><tr><td>产品质量监督抽查</td><td>5423</td></tr><tr><td>计量器具强制检定</td><td>4367</td></tr><tr><td>广告发布内容审查</td><td>3289</td></tr><tr><td>网络交易平台监管</td><td>2156</td></tr>
                                    </tbody></table>
                                    </div>
                                </div>
                                <div class="top10-section">
                                    ...
                                    <tbody>
                                        <tr><td>消防安全</td><td>3276</td></tr><tr><td>交通运输</td><td>2515</td></tr><tr><td>安全生产</td><td>2187</td></tr><tr><td>环境保护</td><td>1856</td></tr><tr><td>医疗器械</td><td>1423</td></tr><tr><td>特种设备</td><td>1198</td></tr><tr><td>网络交易</td><td>867</td></tr><tr><td>广告监管</td><td>656</td></tr>
                                    </tbody></table>
                                    </div>
                                </div>
                            </div>
            ...
            series: [
                {
                    ...
                    data: [
                        { value: 1250, name: '双随机一公开', itemStyle: { color: '#4a9eff' } },
                        { value: 860,  name: '重点检查',   itemStyle: { color: '#ff7f50' } },
                        { value: 520,  name: '专项检查',   itemStyle: { color: '#00d4aa' } },
                        { value: 470,  name: '信用监管',   itemStyle: { color: '#ffd700' } }
                    ]
                }
            ]
        }, true);
        ...
        switch(type) {
            ...
            case 'sv_clue_transfer': {
                ...
                overlay.innerHTML = this.renderSupervisionTrend({
                    title: '违法线索移送趋势分析',
                    kpis: [
                        { label: '违法线索移送总数', value: '99',   suffix: '条' },
                        { label: '去年同期',         value: '85',   suffix: '条' },
                        { label: '同比增加',         value: '14',   suffix: '条' },
                        { label: '同比上升',         value: '16.5', suffix: '%', highlight: 'up' }
                    ],
            ...
            case 'sv_check_reduce': {
                overlay.innerHTML = this.renderSupervisionTrend({
                    ...
                    width: '85vw',
                    kpis: [
                        { label: '预计检查次数', value: '3,234', suffix: '次', highlight: 'total' },
                        { label: '实际检查次数', value: '873',   suffix: '次' },
                        { label: '减少次数',     value: '2,361', suffix: '次', highlight: 'up' },
            ...
            <div class="bright-code-body">
                <div class="bright-kpi-row">
                    <div class="bright-kpi-card">
                        <div class="bright-kpi-label">亮码总次数</div>
                        <div class="bright-kpi-value">12,345<span class="bright-kpi-unit">次</span></div>
                    </div>
                    <div class="bright-kpi-card">
                        <div class="bright-kpi-label">实际亮码次数</div>
                        <div class="bright-kpi-value bright-kpi-green">11,111<span class="bright-kpi-unit">次</span></div>
                    </div>
                    <div class="bright-kpi-card">
                        <div class="bright-kpi-label">未亮码次数</div>
                        <div class="bright-kpi-value bright-kpi-red">1,234<span class="bright-kpi-unit">次</span></div>
                    </div>
                    <div class="bright-kpi-card">
                        <div class="bright-kpi-label">亮码比例</div>
                        <div class="bright-kpi-value bright-kpi-blue">90<span class="bright-kpi-unit">%</span></div>
                    </div>
                </div>
